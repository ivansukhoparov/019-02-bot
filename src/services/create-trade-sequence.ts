...
export const createTradeSequence = (coins: [string, string, string], symbols: any) => {
    ...
    const firstSymbol: TradeSequenceType | null = getSymbol(coins[0], coins[1], coins[1],"buy", symbols);
    ...
    const secondSymbol: TradeSequenceType | null = getSymbol(coins[0], coins[2],coins[0],"sell", symbols);
    ...
    const thirdSymbol: TradeSequenceType | null = getSymbol(coins[2], coins[1], coins[2],"sell", symbols);
