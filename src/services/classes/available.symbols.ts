...
export class AvailableSymbols {
    ...
    constructor(protected marketAdapter: MarketHttpAdapterInterface = ioc.marketHttpAdapter) {
        this.init();
    }
    ...
    init() {
        ...
        Promise.all([allSymbolsPromise, allPricesPromise])
            .then(([allSymbols, allPrices]) => {
